...
How to take mean - just putting mean(4,1,2,5) will NOT work
vec = c(4,1,2,5)
mean(c(4,1,2,5))
...
-9.8*(-2) + 0.03*300           # hint: b1*(-2) + b2*300
# Note: could use b1 and b2 instead of values -9.8 and 0.03
...
# percent change for Trump polling 
xnew = 38
xold = 52
(xnew - xold) / xold * 100
